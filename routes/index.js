// said
// Importation de l'objet Router depuis Express
import { Router } from 'express';
// Importation du contrôleur pour les fonctions liées à l'authentification
import AuthController from '../controllers/AuthController';
// Importation du contrôleur pour les fonctions liées aux fichiers
import FilesController from '../controllers/FilesController';
// Importation du contrôleur principal pour les fonctions liées à l'application
import AppController from '../controllers/AppController';
// Importation du contrôleur pour les fonctions liées aux utilisateurs
import UsersController from '../controllers/UsersController';

// Création d'une instance de Router pour définir les routes de l'application
...
// Route pour télécharger un fichier (par exemple, pour
// permettre aux utilisateurs d'ajouter de nouveaux fichiers)
...
// (par exemple, pour le rendre inaccessible publiquement)
...
// (par exemple, pour télécharger le contenu du fichier)
router.get('/files/:id/data', FilesController.getFile);

// Exportation du routeur pour qu'il puisse
